...
class HomeNewsSection extends StatelessWidget {
  ...
  const HomeNewsSection({super.key, required this.items, required this.hasError, required this.onRetry});
        ...
        children: [
          ...
          if (hasError)
            HomeSectionPlaceholder(
              ...
              description: 'Coba muat ulang untuk mengambil berita terbaru dari server.',
              onRetry: onRetry,
            )
            ...
            Container(
              ...
              child: GestureDetector(
                onTap: () => _bukaArtikel(highlightItem.link),
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    SizedBox(
                      ...
                      height: 190.h,
                      child: AppNetImage(url: highlightItem.imageUrl, fallbackColor: const Color(0xFFE0E0E0)),
                    ),
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            ...
                            style: textTheme.labelLarge?.copyWith(color: const Color(0xFF757575), height: 1.6),
                            maxLines: 3,
                            overflow: TextOverflow.ellipsis,
                          ),
                        ],
