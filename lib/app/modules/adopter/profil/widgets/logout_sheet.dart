        ...
        children: [
          Align(
            ...
            child: GestureDetector(
              ...
              child: Icon(Icons.arrow_back_rounded, size: 30.w, color: const Color(0xFFF87537)),
            ),
          ),
          SizedBox(height: 24.h),
          Image.asset(ImageAsset.imageHewanku, width: 180.w, height: 180.w, fit: BoxFit.contain),
          ...
          Text(
            ...
            textAlign: TextAlign.center,
            style: GoogleFonts.poppins(fontSize: 12.sp, color: const Color(0xFF999999), height: 1.5),
          ),
